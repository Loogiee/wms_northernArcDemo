  ...
  align(center + bottom)[
    ...
    #place(dx: 99%)[
      #text(
       ...
       size: 21pt, weight: "medium", fill: blue
      )
    ]
  ]
)
...
dy:-320pt,dx: -20pt, 
  ...
  #box(fill: rgb("#005397"),stroke: none,width: 50pt,height: 80pt,
  radius:(left: 0pt,
   right:0pt,
   bottom-right:100pt,
   bottom-left:00pt
...
#let smallCardList = (
  ...
  (description: "NIFTY", des: "SENSEX", Value: "-2.631%",Value1:"0.569%", Date: "12-May-2025", Image: "assets/fiveone.png", Image2: "assets/fivetwo.png"),
  (description: "BENCHMARK RETURN(IRR)", Value: "4.25%", Date: "Since Inception", Image: "assets/six.png")
)

// Function to determine color based on value
#let getValueColor(value) = {
  if value.contains("-") and value.contains("%") {
    rgb("#ff0000") // Red for negative percentage with space
  } else if value.contains("%") {
    rgb("#00aa00") // Green for positive percentage
  } else {
    rgb("000") // Green for positive
  }
}
  ...
  #grid(
    ...
    ..smallCardList.map((item) => {
      box(
        ...
        #if item.description != "NIFTY" {
          text(item.Date, size: 15pt, fill: rgb("#0006"), weight: "extrabold", spacing: 2pt, baseline: -3pt)
        }
        // Handle value display based on card type
        #if item.description == "NIFTY" {
          // For NIFTY card, display Value under NIFTY with color coding
          place(dx: 0pt, dy: 105pt)[
            #text(item.Value, size: 25pt, weight: "bold", spacing: 2pt, fill: getValueColor(item.Value))
          ]
          
          // Display Value1 under SENSEX with color coding
          place(dx: 290pt, dy: 105pt)[
            #text(item.Value1, size: 25pt, weight: "bold", spacing: 2pt, fill: getValueColor(item.Value1))
          ]
        } else {
          // For other cards, display Value centered
          align(horizon, text(item.Value, size: 25pt, spacing: 2pt, weight: "bold", stretch: 50%,fill: getValueColor(item.Value)))
        }
      ]
    })
  )
 ...
 available"))
  ...
  pad(..titlePadding, text("Asset Allocation (%)", size: 30pt,  fill: rgb("0e496e"), weight: "extrabold"))
    ...
    #pad(left: 20pt,top: -20pt, grid(
      ...
      inset: 0.5em,
      align: left,
      stack(dir: ltr, spacing: 10pt, rect(width: 12pt, height: 10pt, radius: 50%, fill: rgb(primaryColors.at(0))), text("10 %
Equities", size: 16pt)),
      stack(dir: ltr, spacing: 10pt, rect(width: 12pt, height: 10pt, radius: 50%, fill: rgb(primaryColors.at(1))), text("20 %
Alternatives", size: 16pt)),
      stack(dir: ltr, spacing: 10pt, rect(width: 12pt, height: 10pt, radius: 50%, fill:rgb(primaryColors.at(2))), text("5 %
Fixed Income", size: 16pt)),
      stack(dir: ltr, spacing: 10pt, rect(width: 12pt, height: 10pt, radius: 50%, fill:rgb(primaryColors.at(2))), text("18.5 %
Hybrid", size: 16pt)),
...
#place(bottom + right, dy: 15pt)[
    ...
    height: 490pt,
        ...
        // Main header
        #place(dx: 10pt, dy: -10pt,
            pad(..titlePadding, text("Quarterly Asset Allocation Trends", size: 30pt, fill: rgb("0e496e"), weight: "extrabold"))
        )
  ...
  box(
    ...
    #place(
     ...
     #pad(left: 20pt,top:1pt, grid(
      ...
      inset: 1pt,
      align: left,
      stack(dir: ltr, spacing: 10pt, rect(width: 12pt, height: 10pt, radius: 50%, fill: rgb(primaryColors.at(1))), text("Hybrid", size: 16pt)),
      stack(dir: ltr, spacing: 10pt, rect(width: 12pt, height: 10pt, radius: 50%, fill: rgb(primaryColors.at(2))), text("Equity", size: 16pt)),
      stack(dir: ltr, spacing: 10pt, rect(width: 12pt, height: 10pt, radius: 50%, fill: rgb(primaryColors.at(4))), text("
Debt", size: 16pt)),
      [#stack(dir: ltr, spacing: 10pt, rect(width: 12pt, height: 10pt, radius: 50%, fill: rgb(primaryColors.at(3))), text("Commodities", size: 16pt))],
    ))
  ]
  ]
}
...
#place(dy: 600pt)[
  ...
  (Assets: " Mutual Fund",Amount: [  1,00,55,31,987.97], per: [ 87.9%], Ammount2:[ 1,38,16,76,727.65],per2:[ 89.6%]),
...
#let productwise = (
  (Asset: "AIF", PurchaseValue: "", MarketValue: "", Unrealised:"",DividendInterest:"",Realised:"",IRR:"",Exposure:""),
  (Asset: "Equity", PurchaseValue: "4,04,40,000", MarketValue: "5,89,75,000", Unrealised:"1,85,35,000",DividendInterest:"0",Realised:"0",IRR:"14.8",Exposure:"100"),
  (Asset: "Total", PurchaseValue: "4,04,40,000", MarketValue: "5,89,75,000", Unrealised:"1,85,35,000",DividendInterest:"-",Realised:"-",IRR:"14.8",Exposure:"100"),
  ...
  #table(
    ...
    // Header
    table.header(
    table.cell(rowspan: 2, colspan: 8, align: left + horizon, [#text(fill: heading0,size: 35pt, weight: "bold", [ Portfolio Analysis Report])]),
    ...
    table.cell([#text(fill: heading0, weight: "black", [Unrealised 
    \
    Gain/Loss],size: 20pt)]),
    table.cell([#text(fill: heading0, weight: "black", [Dividend Interest ],size: 20pt)]),
    table.cell([#text(fill: heading0, weight: "black", [Realised 
    \
    Gain/Loss],size: 20pt)]),
...
//Holding Report - Liquid & Equivalent (Liquid/Overnight Funds)
...
#let subasset = (
  ...
  (Asset: "Equity", PurchaseValue: "4,04,40,000", MarketValue: "5,89,75,000", Unrealised:"1,85,35,000",Income:"-",Realised:"0",IRR:"14.8",Exposure:"100"),

  (Asset: "Total", PurchaseValue: "4,04,40,000", MarketValue: "5,89,75,000", Unrealised:"1,85,35,000",Income:"-",Realised:"-",IRR:"14.8",Exposure:"100"),
...
#set table(
  ...
  #table(
    ...
    // Header
    table.header(
    table.cell(rowspan: 2, colspan: 8, align: left + horizon, [#text(fill: heading1,size: 25pt, weight: "bold", [ Portfolio Analysis Report])]),
    table.hline(stroke: rgb(gray)),
    ...
    table.cell([#text(fill: heading1,Fontsize, weight: "black", [ Unrealised 
    \
    Gain/Loss])]),
    table.cell([#text(fill: heading1,Fontsize, weight: "black", [ Income])]),
    table.cell([#text(fill: heading1, Fontsize,weight: "black", [Realised 
    \
    Gain/Loss
  ])]),
...
#let subasset3= (
  ...
  (Name: "Commodities: Gold", folio: "",  units: "",  Purchase_value :"", Inception :"",unrealized:"",Market_value:"",Market_Price:"", absolute:"", XIRR:"",lifedays:""),
  (Name: " Nippon India Gold Savings-G", folio: " xxxxxxxxxx",  units: "3,15,292.8",  Purchase_value :"45,00,000", Inception :"-",unrealized:" 45,70,090.8",Market_value:" 90,70,090.8",Market_Price:"3,21,52,906", absolute:"101.6", XIRR:"6",lifedays:"0"),
  (Name: "Total", folio: "-",   units: "3,15,292.8",  Purchase_value :"45,00,000", Inception :"-",unrealized:" 45,70,090.8",Market_value:" 90,70,090.8",Market_Price:"3,21,52,906", absolute:"-", XIRR:"-",lifedays:"-"),
...
#set table(
  ...
  #table(
    ...
    // Header
    table.header(
    table.cell(rowspan: 2, colspan: 11, align: left + horizon, [#text(fill: heading1,size: 25pt, weight: "bold", [ Portfolio Analysis Report])]),
    table.hline(stroke: rgb(gray)),
...
#let subasset1 = (
  ...
  ( Provider_name: " Marcellus Consistent Compounders Portfolio", Folio: " Inflow",Inflow:" 3,34,63,369", Outflow: "0", Market_value:"5,85,60,895.8",Market_value_date:"22 Jul 2024",XIRR:"15",Assest_Exposure:"100"),
  ( Provider_name: "Total", Folio: "-",Inflow:" 3,34,63,369",  Outflow: "-", Market_value:"5,85,60,895.8",Market_value_date:"-",XIRR:"-",Assest_Exposure:"100"),
...
#let subasset3= (
  ...
  (Name: "L&T Finance Ltd", Code: "undefined",  shares: "1,85,074",  Purchase_Price :"172.9", Purchase_Value :"3,20,00,238.6",Dividend:"0",Market_price:"173.7",Market_value:"3,21,52,906", Unrealized_Gain:"1,52,667.4", Gain_loss:"0",asset_exposure:"32"),
)
#set table(
...
#set table(
  ...
  #table(
    ...
    // Header
    table.header(
    table.cell(rowspan: 2, colspan: 6, align: left + horizon, [#text(fill: heading1,size: 25pt, weight: "bold", [ Portfolio Analysis Report])]),
    table.hline(stroke: rgb(gray)),
...
#set table(
  ...
  #table(
    ...
    // Header
    table.header(
    table.cell(rowspan: 2, colspan: 4, align: left + horizon, [#text(fill: heading1,size: 25pt, weight: "bold", [ Portfolio Analysis Report])]),
    table.hline(stroke: rgb(gray)),
...
fill: none,
  ..topdata.map(row => {
        (
          text(size: 16pt, row.words), 
          text(size: 16pt, row.word1),          
        )
      }).flatten()
)
...
#place(
dx: 20pt,dy:30pt)[#text(" Market Capitalization Allocation(%)", size: 30pt,  fill: rgb("0e496e"), weight: "extrabold")]
  ...
  #box(
   ...
   stroke: rgb("#cecece"),
    ...
    #table(
      ...
      ..bottomdata.map(row => {
        (
          text(size: 16pt, row.Metric), 
          text(size: 16pt, row.Values), 
...
#set table(
  ...
  #table(
    ...
    // Header
    table.header(
    table.cell(rowspan: 2, colspan: 3, align: left + horizon, [#text(fill: heading1,size: 25pt, weight: "bold", [ Portfolio Analysis Report])]),
    table.hline(stroke: rgb(gray)),
...
#let subasset3= (
  ...
  (assetcls: "Others", subasset: " 89,41,78,342.3",  name: "63.3",folio:" 6259412/91",transaction:"03 Nov 2023",description:"MFSUB",units:"5,69,077.2",purchase:"24.6",amount: "1,39,99,300"),
)
#set table(
  ...
  #table(
    ...
    // Header
    table.header(
    table.cell(rowspan: 2, colspan: 9, align: left + horizon, [#text(fill: heading1,size: 25pt, weight: "bold", [ Portfolio Analysis Report])]),
    table.hline(stroke: rgb(gray)),
...
#set table(
  ...
  #table(
    ...
    // Header
    table.header(
    table.cell(rowspan: 2, colspan: 5, align: left + horizon, [#text(fill: heading1,size: 25pt, weight: "bold", [ Portfolio Analysis Report])]),
    table.hline(stroke: rgb(gray)),
...
#let subasset3= (
  ...
  (Scheme: "DSP Bond Ret-IDCWQ", Quantity: "",   PurchaseDate: " ",  PurchasePrice:"", PurchaseValue:"",SaleDate:"", SalePrice:"", SaleValue:"", DaysHeld:"",ShortTerm:"", LongTerm:""),
  (Scheme: "DSP Bond Ret-IDCWQ", Quantity: "10,000",   PurchaseDate: "02 Dec 2023",  PurchasePrice:" 10
", PurchaseValue:"1,00,000",SaleDate:" 02 Dec 2023", SalePrice:"10.8", SaleValue:"1,08,500", DaysHeld:"-",ShortTerm:"0", LongTerm:"8,500"),
  (Scheme: "DSP Bond Ret-IDCWQ", Quantity: "10,000",   PurchaseDate: "02 Dec 2023",  PurchasePrice:" 10
", PurchaseValue:"1,00,000",SaleDate:" 02 Dec 2023", SalePrice:"10.8", SaleValue:"1,08,500", DaysHeld:"-",ShortTerm:"0", LongTerm:"8,500"),
  (Scheme: "DSP Bond Ret-IDCWQ", Quantity: "10,000",   PurchaseDate: "02 Dec 2023",  PurchasePrice:" 10
", PurchaseValue:"1,00,000",SaleDate:" 02 Dec 2023", SalePrice:"10.8", SaleValue:"1,08,500", DaysHeld:"-",ShortTerm:"0", LongTerm:"8,500"),
...
#let subasset3= (
  ...
  (scheme: " Credit Risk", policy: "  AAA - Minimum of 80%AA - Minimum of 20%
",  currentpo: " AAA: 95.4%AA: 4.6%",  complaince:"Compliant"),
  (scheme: "Modified Duration", policy: " 3 to 5 Years
",  currentpo: " 2.8",  complaince:" Compliant adding Duration"),
  (scheme: "Maturity buckets", policy: " 0 - 3 years: Min 30%
 3 - 5 years: Min 40%
 5 - 7 years: Max 20%
 7 & Above years: Max 20%",  currentpo: " 0 - 3 years: 33%
 3 - 5 years: 53%
 5 - 7 years: 3%
 7 & Above years: 11%",  complaince:"Consider adding to the long-term maturity bucket"),
 ...
 (scheme: "Mirae Asset focused plan", policy: " Up to 100%",  currentpo: "-",  complaince:"Compliant"),(scheme: " Equity", policy: " Up to 100%",  currentpo: "-",  complaince:"Compliant"),
...
#text([This statement is for the exclusive and confidential use of the addressee only. Any is distribution, use or reproduction of this report without prior written permission of Kfintech Limited ("Kfintech") is unauthorised
 ...
 regulators. Therefore, any mentions of the updated name should be interpreted within this ongoing regulatory context.],weight: "regular",size: 20pt))]
